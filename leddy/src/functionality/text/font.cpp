...
{
    const PROGMEM uint8_t arr[ct_len][8] = {
        ...
        {0x6C, 0xFE, 0xFE, 0xFE, 0x7C, 0x38, 0x10, 0x00}, // U+0080 (❤️)
        {0xFF, 0x98, 0xF4, 0x92, 0x71, 0x1F, 0x50, 0xA0}, // U+0081 (first half Zeus logo)
        {0x3C, 0x0C, 0x3C, 0x24, 0x3B, 0x2D, 0x2D, 0x24}, // U+0082 (second half Zeus logo)
